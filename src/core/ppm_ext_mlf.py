...
class PpmExtMlf(GamsClass):
    """Translation unit for ppm_ext.mlf."""

    # Instance attributes
    module_name: str = "ppm_ext_mlf"
    gams_source: str = "ppm_ext.mlf"
