...
class CalibaseMlf(GamsClass):
    """Translation unit for calibase.mlf."""

    # Instance attributes
    module_name: str = "calibase_mlf"
    gams_source: str = "calibase.mlf"
...
""",
    ...
    def exec1(self: CalibaseMlf) -> None:
        self.tc.add_gams_code(
            module=self,
            phase="run",
            code=r"""
...
""",
    ...
    def exec2(self: CalibaseMlf) -> None:
        self.tc.add_gams_code(
            module=self,
            phase="run",
            code=r"""
...
""",
    ...
    def exec3(self: CalibaseMlf) -> None:
        self.tc.add_gams_code(
            module=self,
            phase="run",
            code=rf"""
